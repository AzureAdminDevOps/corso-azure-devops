...
> Convenzione del file DOCENTE: ogni quesito è riportato per esteso prima della risposta.  
> Struttura: **Domanda → Risposta → Motivazione/nota docente**.
...
**Nota docente:**  
Collegare al principio del minimo privilegio.
...
**Nota docente:**  
Collegare a scalabilità amministrativa e least privilege.
...
**Nota docente:**  
Serve a distinguere ruoli directory da ruoli Azure Resource Manager.
...
**Nota docente:**  
Questa è una vera checklist di troubleshooting RBAC.
...
**Nota docente:**  
Qui devono emergere due concetti:
1. minimo privilegio;
...
**Nota docente:**  
Far scegliere lo scope minimo compatibile con il requisito.
...
## Regola per i prossimi file DOCENTE

Ogni contenuto interrogativo deve rispettare questa struttura:

```text
Domanda
↓
Risposta attesa / soluzione
↓
Motivazione o nota docente
```
