...
- sottoscrizione e tenant verificati:
- percorso Entra eseguito: A / B
- resource group temporaneo:
...
- tag e significato:
- lock e operazione impedita:
- stato di Cost Analysis:
- budget creato o limitazione documentata:
- motivo per cui il budget non blocca la spesa:
